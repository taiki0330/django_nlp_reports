...
from .views import GenreList, CrimeList, CrimeCreate, CrimeDetail, SuspectDetail, VictimDetail, GenerateTextView
...
urlpatterns = [
    ...
    path('crimes/<int:pk>/generate', GenerateTextView.as_view(), name='generate'),
